...
*   **Bilevel Mixed-Integer Programs (BiMIP)**:
    ...
    *   Optimistic bilevel optimization with coupling constraints support.
...
*   **Multiple Solution Methods**: Including exact modes (KKT, Strong Duality) and quick modes (Approximately 1-2 orders of magnitude faster than existing global optimal algorithms for BiMIP).
