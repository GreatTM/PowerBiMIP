function run_milp_10_20_50_2310()
%==========================================================================
% run_milp_10_20_50_2310
%--------------------------------------------------------------------------
% 作用：
%   求解算例 milp_10_20_50_2310（由 .mps + .aux 定义的 BiMIP）。
%   流程：
...
%==========================================================================
    ...
    aux_path = fullfile(this_dir, "milp_10_20_50_2310.aux");
    mps_path = fullfile(this_dir, "milp_10_20_50_2310.mps");
    ...
    %---------------------------
    fprintf('\n============================================================\n');
    fprintf('Solving instance: milp_10_20_50_2310\n');
    fprintf('MPS: %s\nAUX: %s\n', mps_path, aux_path);
    fprintf('============================================================\n');
