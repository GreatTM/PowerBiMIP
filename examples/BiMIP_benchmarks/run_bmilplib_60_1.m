function run_bmilplib_60_1()
%==========================================================================
% run_bmilplib_60_1
%--------------------------------------------------------------------------
% 作用：
%   求解算例 bmilplib_60_1（由 .mps + .aux 定义的 BiMIP）。
%   流程：
...
%==========================================================================
    ...
    aux_path = fullfile(this_dir, "bmilplib_60_1.aux");
    mps_path = fullfile(this_dir, "bmilplib_60_1.mps");
    ...
    %---------------------------
    fprintf('\n============================================================\n');
    fprintf('Solving instance: bmilplib_60_1\n');
    fprintf('MPS: %s\nAUX: %s\n', mps_path, aux_path);
    fprintf('============================================================\n');
