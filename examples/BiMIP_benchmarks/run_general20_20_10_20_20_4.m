function [time, iter, obj, gap] = run_general20_20_10_20_20_4(method, solver)
%==========================================================================
% run_general20-20-10-20-20-4
%--------------------------------------------------------------------------
% 作用：
%   求解算例 general20-20-10-20-20-4（由 .mps + .aux 定义的 BiMIP）。
%   流程：
...
%==========================================================================
    ...
    aux_path = fullfile(this_dir, "general20-20-10-20-20-4.aux");
    mps_path = fullfile(this_dir, "general20-20-10-20-20-4.mps");
    ...
    %---------------------------
    fprintf('\n============================================================\n');
    fprintf('Solving instance: general20-20-10-20-20-4\n');
    fprintf('MPS: %s\nAUX: %s\n', mps_path, aux_path);
    fprintf('============================================================\n');
    ...
    time = BiMIP_record.total_time;
    iter = BiMIP_record.iteration_num;
    obj = BiMIP_record.UB(end);
    gap = BiMIP_record.gap;
end
