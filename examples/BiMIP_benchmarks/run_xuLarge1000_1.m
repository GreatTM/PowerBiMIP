function [time, iter, obj, gap] = run_xuLarge1000_1(method, solver)
%==========================================================================
% run_xuLarge1000-1
%--------------------------------------------------------------------------
% 作用：
%   求解算例 xuLarge1000-1（由 .mps + .aux 定义的 BiMIP）。
%   流程：
...
%==========================================================================
    ...
    aux_path = fullfile(this_dir, "xuLarge1000-1.aux");
    mps_path = fullfile(this_dir, "xuLarge1000-1.mps");
    ...
    %---------------------------
    fprintf('\n============================================================\n');
    fprintf('Solving instance: xuLarge1000-1\n');
    fprintf('MPS: %s\nAUX: %s\n', mps_path, aux_path);
    fprintf('============================================================\n');
