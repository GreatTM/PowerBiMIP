function run_general20_30_10_20_20_7()
%==========================================================================
% run_general20-30-10-20-20-7
%--------------------------------------------------------------------------
% 作用：
%   求解算例 general20-30-10-20-20-7（由 .mps + .aux 定义的 BiMIP）。
%   流程：
...
%==========================================================================
    ...
    aux_path = fullfile(this_dir, "general20-30-10-20-20-7.aux");
    mps_path = fullfile(this_dir, "general20-30-10-20-20-7.mps");
    ...
    %---------------------------
    fprintf('\n============================================================\n');
    fprintf('Solving instance: general20-30-10-20-20-7\n');
    fprintf('MPS: %s\nAUX: %s\n', mps_path, aux_path);
    fprintf('============================================================\n');
