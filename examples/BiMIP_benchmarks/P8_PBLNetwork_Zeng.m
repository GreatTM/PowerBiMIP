function P8_PBLNetwork_Zeng()
%==========================================================================
% run_VSP_N22_L77_B200_C9
%==========================================================================
    clc; clearvars;
    %---------------------------
    % 1) 清理 YALMIP 环境
    ...
    aux_path = fullfile(this_dir, "VSP_N22_L77_B200_C9.aux");
    mps_path = fullfile(this_dir, "VSP_N22_L77_B200_C9.mps");
    if ~isfile(aux_path)
    ...
    %---------------------------
    fprintf('\n============================================================\n');
    fprintf('Solving instance: VSP_N22_L77_B200_C9\n');
    fprintf('MPS: %s\nAUX: %s\n', mps_path, aux_path);
    fprintf('============================================================\n');
