function run_milp_4_20_10_0110()
%==========================================================================
% run_milp_4_20_10_0110
%--------------------------------------------------------------------------
% 作用：
%   求解算例 milp_4_20_10_0110（由 .mps + .aux 定义的 BiMIP）。
%   流程：
...
%==========================================================================
    ...
    aux_path = fullfile(this_dir, "milp_4_20_10_0110.aux");
    mps_path = fullfile(this_dir, "milp_4_20_10_0110.mps");
    ...
    %---------------------------
    fprintf('\n============================================================\n');
    fprintf('Solving instance: milp_4_20_10_0110\n');
    fprintf('MPS: %s\nAUX: %s\n', mps_path, aux_path);
    fprintf('============================================================\n');
