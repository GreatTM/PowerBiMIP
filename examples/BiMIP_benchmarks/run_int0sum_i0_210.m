function run_int0sum_i0_210()
%==========================================================================
% run_int0sum_i0_210
%--------------------------------------------------------------------------
% 作用：
%   求解算例 int0sum_i0_210（由 .mps + .aux 定义的 BiMIP）。
%   流程：
...
%==========================================================================
    ...
    aux_path = fullfile(this_dir, "int0sum_i0_210.aux");
    mps_path = fullfile(this_dir, "int0sum_i0_210.mps");
    ...
    %---------------------------
    fprintf('\n============================================================\n');
    fprintf('Solving instance: int0sum_i0_210\n');
    fprintf('MPS: %s\nAUX: %s\n', mps_path, aux_path);
    fprintf('============================================================\n');
