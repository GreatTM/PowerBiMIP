function run_mik_250_1_100_1_0_100()
%==========================================================================
% run_mik-250-1-100-1_0_100
%--------------------------------------------------------------------------
% 作用：
%   求解算例 mik-250-1-100-1_0_100（由 .mps + .aux 定义的 BiMIP）。
%   流程：
...
%==========================================================================
    ...
    aux_path = fullfile(this_dir, "mik-250-1-100-1_0_100.aux");
    mps_path = fullfile(this_dir, "mik-250-1-100-1_0_100.mps");
    ...
    %---------------------------
    fprintf('\n============================================================\n');
    fprintf('Solving instance: mik-250-1-100-1_0_100\n');
    fprintf('MPS: %s\nAUX: %s\n', mps_path, aux_path);
    fprintf('============================================================\n');
