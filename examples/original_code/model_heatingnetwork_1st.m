function model_heatingnetwork_1st(varargin)
...
%     var_1st.recourse(k).heatingnetwork.Tau_pipe_s_in = sdpvar( ...
%         num_initialtime+num_period_heat, num_pipe, 'full');
%     var_1st.recourse(k).heatingnetwork.Tau_pipe_s_out = sdpvar( ...
%         num_initialtime+num_period_heat, num_pipe, 'full');
%     var_1st.recourse(k).heatingnetwork.Tau_pipe_r_in = sdpvar( ...
%         num_initialtime+num_period_heat, num_pipe, 'full');
%     var_1st.recourse(k).heatingnetwork.Tau_pipe_r_out = sdpvar( ...
%         num_initialtime+num_period_heat, num_pipe, 'full');
%     var_1st.recourse(k).heatingnetwork.Tau_node_s = sdpvar( ...
%         num_initialtime+num_period_heat, num_node, 'full');
%     var_1st.recourse(k).heatingnetwork.Tau_node_r = sdpvar( ...
%         num_initialtime+num_period_heat, num_node, 'full');
%     var_1st.recourse(k).heatingnetwork.h_source = sdpvar( ...
%         num_initialtime+num_period_heat, num_source, 'full');
%     var_1st.recourse(k).heatingnetwork.h_load = sdpvar( ...
%         num_initialtime+num_period_heat, num_load, 'full');
% end


%% Initialize variable
for k = 1:num_scenario
    var_1st.recourse(k).heatingnetwork.Tau_pipe_s_in(1:num_initialtime,:) = ...
        data_initial(loc_initial_Tau_s);
    var_1st.recourse(k).heatingnetwork.Tau_pipe_r_in(1:num_initialtime,:) = ...
        data_initial(loc_initial_Tau_r);
    var_1st.recourse(k).heatingnetwork.Tau_pipe_s_out(1:num_initialtime,:) = ...
        data_initial(loc_initial_Tau_s);
    var_1st.recourse(k).heatingnetwork.Tau_pipe_r_out(1:num_initialtime,:) = ...
        data_initial(loc_initial_Tau_r);
    var_1st.recourse(k).heatingnetwork.Tau_node_s(1:num_initialtime,:) = ...
        data_initial(loc_initial_Tau_s);
    var_1st.recourse(k).heatingnetwork.Tau_node_r(1:num_initialtime,:) = ...
        data_initial(loc_initial_Tau_r);
    var_1st.recourse(k).heatingnetwork.h_source(1:num_initialtime,:) = 0;
    var_1st.recourse(k).heatingnetwork.h_load(1:num_initialtime,:) = 0;
end
...
for k = 1:num_scenario
    for j = 1:num_pipe
        model.main_problem.cons = model.main_problem.cons + ( ...
            (var_1st.recourse(k).heatingnetwork.Tau_pipe_s_out(t,j) == ...
            (1-beta(j)) * data.param_Tau_amb(t) + ...
            beta(j) * ...
            ((1-kappa(j)) * ...
            var_1st.recourse(k).heatingnetwork.Tau_pipe_s_in(t-gamma(j)-1,j) + ...
            kappa(j) * ...
            var_1st.recourse(k).heatingnetwork.Tau_pipe_s_in(t-gamma(j),j))) : ...
            'heatingsys: supply Tau of pipe ');
        model.main_problem.cons = model.main_problem.cons + ( ...
            (var_1st.recourse(k).heatingnetwork.Tau_pipe_r_out(t,j) == ...
            (1-beta(j)) * data.param_Tau_amb(t) + ...
            beta(j) * ...
            ((1-kappa(j)) * ...
            var_1st.recourse(k).heatingnetwork.Tau_pipe_r_in(t-gamma(j)-1,j) + ...
            kappa(j) * ...
            var_1st.recourse(k).heatingnetwork.Tau_pipe_r_in(t-gamma(j),j))) : ...
    ...
    for i = 1:num_node
        ...
        if data_node(i,loc_nodetype) == 0
            if ~isempty(set_pipe_fnode)
                model.main_problem.cons = model.main_problem.cons + ( ...
                    (var_1st.recourse(k).heatingnetwork.Tau_pipe_s_in(t,set_pipe_fnode) == ...
                    var_1st.recourse(k).heatingnetwork.Tau_node_s(t,i)) : ...
                    ['heatingsys: suppley Tau of source node ' num2str(current_node)]);
                model.main_problem.cons = model.main_problem.cons + ( ...
                    (var_1st.recourse(k).heatingnetwork.Tau_pipe_r_out(t,set_pipe_fnode) == ...
                    var_1st.recourse(k).heatingnetwork.Tau_node_r(t,i)) : ...
                    ['heatingsys: return Tau of source node ' num2str(current_node)]);
                model.main_problem.cons = model.main_problem.cons + ( ...
                    (var_1st.recourse(k).heatingnetwork.h_source(t,1) == ...
        ...
        if data_node(i,loc_nodetype) == 1
            ...
            if ~isempty(set_pipe_fnode)
                ...
                model.main_problem.cons = model.main_problem.cons + ( ...
                    (var_1st.recourse(k).heatingnetwork.Tau_pipe_s_in(t,set_pipe_fnode) == ...
                    var_1st.recourse(k).heatingnetwork.Tau_node_s(t,i)*ones(1,length(set_pipe_fnode))) : ...
                    ['heatingsys: supply Tau of cross node ' num2str(current_node)]);
                model.main_problem.cons = model.main_problem.cons + ( ...
                    (var_1st.recourse(k).heatingnetwork.Tau_node_s(t,i)* ...
                    sum(data_pipe(set_pipe_fnode,loc_massflow)) == ...
                    var_1st.recourse(k).heatingnetwork.Tau_pipe_s_out(t,set_pipe_tnode)* ...
            ...
            if ~isempty(set_pipe_tnode)
                ...
                model.main_problem.cons = model.main_problem.cons + ( ...
                    (var_1st.recourse(k).heatingnetwork.Tau_pipe_r_in(t,set_pipe_tnode) == ...
                    var_1st.recourse(k).heatingnetwork.Tau_node_r(t,i)*ones(1,length(set_pipe_tnode))) : ...
        ...
        if data_node(i,loc_nodetype) == 2
            if ~isempty(set_pipe_tnode)
                model.main_problem.cons = model.main_problem.cons + ( ...
                    (var_1st.recourse(k).heatingnetwork.Tau_pipe_s_out(t,set_pipe_tnode) == ...
                    var_1st.recourse(k).heatingnetwork.Tau_node_s(t,i)*ones(1,length(set_pipe_tnode))) : ...
                ...
                model.main_problem.cons = model.main_problem.cons + ( ...
                    (var_1st.recourse(k).heatingnetwork.h_load(t, ...
...
for k = 1:num_scenario
    model.main_problem.cons = model.main_problem.cons + ( ...
        (var_1st.recourse(k).heatingnetwork.Tau_node_s(:,:) >= ...
        data_node(1,loc_Tsmin)) : '');
    model.main_problem.cons = model.main_problem.cons + ( ...
        (var_1st.recourse(k).heatingnetwork.Tau_node_s(:,:) <= ...
        data_node(1,loc_Tsmax)) : '');
    model.main_problem.cons = model.main_problem.cons + ( ...
        (var_1st.recourse(k).heatingnetwork.Tau_node_r(:,:) >= ...
...
for k = 1:num_scenario
    model.main_problem.cons = model.main_problem.cons + ( ...
        (var_1st.recourse(k).heatingnetwork.Tau_node_s(num_end,1) >= ...
        data_initial(loc_initial_Tau_s)) : '');
    model.main_problem.cons = model.main_problem.cons + ( ...
        (var_1st.recourse(k).heatingnetwork.Tau_node_r(num_end,1) <= ...
        data_initial(loc_initial_Tau_r)) : '');
end
