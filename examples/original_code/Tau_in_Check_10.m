...
epsilon = 0:0.01:1;
%% Tau_in_up
alpha = alpha0(:,end/2+1)*(1-epsilon) + alpha0(:,end)*epsilon;
beta = beta0(:,end/2+1)*(1-epsilon) + beta0(:,end)*epsilon;
...
%% Tau_in_low
alpha = alpha0(:,1)*(1-epsilon) + alpha0(:,end/2)*epsilon;
beta = beta0(:,1)*(1-epsilon) + beta0(:,end/2)*epsilon;
for k_building = 1:num_building
