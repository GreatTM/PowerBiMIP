% Run MibS benchmark instance K5050W20 (Knapsack Interdiction) using PowerBiMIP
%
...
% Path: MibSdata/interdiction/MCDM/NO_CORR/50_ITEMS_1000/K5050W20.KNP.mps
mps_file = fullfile(base_dir, 'MibSdata', 'interdiction', 'MCDM', 'NO_CORR', '50_ITEMS_1000', 'K5050W20.KNP.mps');
txt_file = fullfile(base_dir, 'MibSdata', 'interdiction', 'MCDM', 'NO_CORR', '50_ITEMS_1000', 'K5050W20.KNP.txt');
...
ops = BiMIPsettings(...
    ...
    'max_iterations', 200, ...      % Set iteration limit (larger instance)
