% Run MibS benchmark instance milp_10_20_50_2310 using PowerBiMIP
%
...
mps_file = fullfile(base_dir, 'MibSdata', 'notInterdiction', 'milp_10_20_50_2310.mps');
txt_file = fullfile(base_dir, 'MibSdata', 'notInterdiction', 'milp_10_20_50_2310.txt');
...
% Note: You may need to specify 'solver' if Gurobi is not default or installed
% ops.solver = 'gurobi'; 
...
try
    ...
    % fprintf('Solve Time: %.2f s\n', sum(BiMIP_record.time_history)); % Assuming time_history exists or just check log
