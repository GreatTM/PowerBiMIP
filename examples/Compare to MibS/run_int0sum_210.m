% Run MibS benchmark instance int0sum_i0_210 using PowerBiMIP
%
...
mps_file = fullfile(base_dir, 'MibSdata', 'notInterdiction', 'Random', 'int0sum_i0_210.mps');
txt_file = fullfile(base_dir, 'MibSdata', 'notInterdiction', 'Random', 'int0sum_i0_210.txt');
