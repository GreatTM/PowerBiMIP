function NetworkDesign_Zeng(num_nodes, num_links, budget, num_candidates)
...
%       num_candidates : 候选站点数 (默认 9)
    ...
    %% 1. 初始化与参数处理
    if nargin < 4, num_candidates = 14; end
    ...
    %% 6. 求解 (可选，如果只需导出可注释掉)
    ops = BiMIPsettings('perspective', 'optimistic', ... % 'optimistic'
        'method', 'quick', ...
        'solver', 'cplex', ...
        'verbose', 2, ...
        'optimal_gap', 1e-4);
